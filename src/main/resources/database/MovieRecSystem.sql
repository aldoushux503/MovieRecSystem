...
CREATE TABLE IF NOT EXISTS `MovieRecSystem`.`PersonRole` (
  `person_role_id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `MovieRecSystem`.`ContentContributors` (
  ...
  PRIMARY KEY (`movie_id`, `person_id`, `person_role_id`),
  INDEX `fk_ContentContributors_Person1_idx` (`person_id` ASC) VISIBLE,
  INDEX `fk_ContentContributors_PersonRole1_idx` (`person_role_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MovieRecSystem`.`UserInteractions` (
  ...
  PRIMARY KEY (`movie_id`, `user_id`, `interactions_id`),
  INDEX `fk_Movie_has_User_User3_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_Movie_has_User_Movie3_idx` (`movie_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MovieRecSystem`.`UserPreferredGenres` (
  ...
  INDEX `fk_Genre_has_User_User1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_Genre_has_User_Genre1_idx` (`genre_id` ASC) VISIBLE,
